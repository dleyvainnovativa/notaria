...
<head>
    ...
    <meta property="og:description" content="@yield('description',  env('APP_NAME').' | Panel')">
...
<body class="bg-dark">
    <input type="hidden" id="memorial_slug" value="">
    <div id="wrapper" class="text-bg-dark ">
        <div id="sidebar-overlay" class="d-none"></div>
        @include('admin.components.sidebar_init')
