...
<div class="row g-4">
        ...
        <div class="card card-dark border border-dark bg-dark">
            <div class="card-body p-4 text-dark">
                <div class="row g-2">
                    ...
                    <div class="col-12">
                        <h3 id="revenue-value" class="my-0 fw-bold">0</h3>
                    </div>
    ...
    <div class="col-auto">
        <a href="{{route('admin.declaranot')}}" class="btn btn-primary"><i class="fas fa-file-upload me-2"></i>Subir documento</a>
    </div>
    <div class="col-auto">
            ...
            <div class="card-body p-0">
                <div class="list-group list-group-flush">
                    <div class="list-group-item p-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                        ...
                        <small class="opacity-75 text-muted mt-2 mt-md-0 d-flex align-items-center gap-1 text-end">
