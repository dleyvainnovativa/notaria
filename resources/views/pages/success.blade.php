            ...
            <div class="col-lg-12 col-12 col-md-12 mx-auto">
                <div class="row g-2 text-center">
                    <div class="col-12">
                        ...
                        <h2 class="">
                            <i class="far fa-circle-check text-success fa-2xl"></i>
                        </h2>
                    </div>
                    <div class="col-12">
            ...
            <div class="col-lg-8 col-12 col-md-12 mx-auto text-center">
                <div class="card card-dark border border-dark text-dark">
                    <div class="card-body p-4">
                        <h3 class="fw-bold">Gracias por comprar con nosotros</h3>
                        <p class=" text-muted">
                            Hemos recibido tu solicitud correctamente y el pago fue procesado con éxito.
                            Muy pronto recibirás un correo con los detalles de tu reservación y el seguimiento.
                        </p>
                    </div>
                </div>
            </div>
